...
export default function BlogPage_Card() {
  ...
  const isLiked = blogData?.likes?.some((like) => like?.user?.id === user_id);
  ...
  async function LikeAPI() {
    try {
      ...
      if (data === "liked") {
        ...
        setBlogData((prev) => ({
          ...prev,
          likes: prev.likes.filter((like) => like?.user?.id !== user_id),
        }));
      }
    } catch (err) {
      console.log(err);
  ...
  async function UpdateAPI() {
    ...
    const updatePostAPIData = await updatePostAPI(data, token);
  ...
  return (
    <section
      className={`
            ...
            ${theme === "dark" ? "bg-gray-800 text-white/90" : "bg-white"}
        `}
    >
      <Button
      ...
      {toggleUpdateBlog && (
        ...
        >
          ...
          <div className="flex justify-center items-center gap-6 mt-4">
            <Button onClick={() => UpdateAPI()} className="bg-green-500 px-4.5">
              save
            </Button>

            <Button
              onClick={() => setToggleUpdateBlog(false)}
      ...
      {!toggleUpdateBlog && (
        ...
        >
          ...
          <div className="text-xs text-gray-500 mb-4 flex flex-col gap-1">
            ...
            <span>
              🔄 Updated:
              {blogData ? " " + blogData.updatedAt?.split("T")[0] : "undefined"}
            </span>
          </div>
          ...
          <div className="flex items-center justify-between border-t pt-3 text-gray-600">
              ...
              >
                ...
                <span
                  className={`
                                ...
                                `}
                >
                  {toggleCommentSection === true ? "close" : "comments"}
                </span>
              </button>
            </div>
            ...
            {currentPostOwner !== true ? (
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <Button onClick={() => DeleteAPI()} className="bg-red-500">
                  delete
                </Button>
